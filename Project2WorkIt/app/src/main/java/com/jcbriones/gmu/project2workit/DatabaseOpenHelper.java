...
public class DatabaseOpenHelper extends SQLiteOpenHelper {
    ...
    final private static String CREATE_CMD = "CREATE TABLE "+TABLE_NAME+" (" + _ID +" INTEGER PRIMARY KEY AUTOINCREMENT, " +WORKOUT + " TEXT NOT NULL, " +WEIGHT + " TEXT NOT NULL, " +REPS + " TEXT NOT NULL, " +SETS + " TEXT NOT NULL, " +NOTES + " TEXT NOT NULL)";
